      ...
      <div class="grid gap-6 mb-6 md:grid-cols-2">
        ...
        <div v-if="entityType === 'user' && entityId">
            <div class="flex justify-between">
              ...
              <router-link :to="`/add-address/${entityId}`" class="text-sm underline font-normal">Ajouter une adresse</router-link>
            </div>
        ...
        <div v-if="entityType === 'product' && entityId">
          <div class="flex justify-between">
            ...
            <router-link :to="`/add-productPicture/${entityId}`" class="text-sm underline font-normal">Ajouter une image</router-link>
          </div>
