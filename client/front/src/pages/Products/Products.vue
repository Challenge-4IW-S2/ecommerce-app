...
const getProducts = async (page, orderBy, categories, valueMin, valueMax) => {
    try {
...
onMounted(async () => {
    await getProducts(productsPerPage.value, order.value, category.value, priceMin.value, priceMax.value);
});
