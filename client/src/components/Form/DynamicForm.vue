...
const { formData, errors, entityStructure, handleSubmit, handleDelete } = useEntityForm(entityType, entityId,import.meta.env.VITE_API_BASE_URL);
document.addEventListener('DOMContentLoaded', function () {
  const accordionButtons = document.querySelectorAll('#accordion-arrow-icon [data-accordion-target]');
